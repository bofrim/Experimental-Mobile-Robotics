...
def main():
    ...
    with state_machine:
        ...
        smach.StateMachine.add(
            ...
            transitions={"approach_par": "APPROACH_PAR"},
        )
        ...
        smach.StateMachine.add(
            "PUSH_PAR",
            PushParallel(rate, cmd_vel_pub),
            transitions={"approach_perp": "APPROACH_PERP"},
        )

        smach.StateMachine.add(
            "APPROACH_PERP",
            ApproachPerpendicular(rate, cmd_vel_pub),
            transitions={"push_perp": "PUSH_PERP"},
        )
