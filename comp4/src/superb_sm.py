...
from superb_states import SuperbDriver, AtLineSuperb
...
def main():
    ...
    with state_machine:
        ...
        smach.StateMachine.add(
            "AT_LINE",
            AtLineSuperb(rate, light_pubs=light_pubs, sound_pub=sound_pub, initial_line=initial_line),
            transitions={
                "drive": "DRIVE",
        ...
        smach.StateMachine.add(
            ...
            transitions={"turn_180": "TURN_180_2", "exit": "exit"},
        )
        ...
        smach.StateMachine.add(
            "TURN_180_S_1",
            Turn(cmd_vel_pub, 130, "superb_shortcut"),
            transitions={"superb_shortcut": "SUPERB_DRIVER"},
        )

        smach.StateMachine.add(
            "SUPERB_DRIVER",
            SuperbDriver(rate, cmd_vel_pub),
            transitions={"advance": "ADVANCE", "exit": "exit"},
        )

        smach.StateMachine.add(
            "TURN_180_S_2",
            Turn(cmd_vel_pub, 130, "off_ramp"),
            transitions={"off_ramp": "OFF_RAMP"},
        )
